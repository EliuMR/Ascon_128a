...
HD_PWD='D:/Documentos/Estudio/Maestria/2-Periodo/Diseno/Ascon-128a-/Cifrador_Ascon128a/Cifrador_Ascon.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ascon_Cifrador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ascon_Cifrador.tcl
