...
signal P8_0,P8_1,P8_2,P8_3,P8_4,P8_5,P8_6,P8_7: std_logic_vector(7 downto 0);
...
alias x4: std_logic_vector(63 downto 0) is Estado(63 downto 0);
alias x3: std_logic_vector(63 downto 0) is Estado(127 downto 64);
alias x2: std_logic_vector(63 downto 0) is Estado(191 downto 128);
alias x1: std_logic_vector(63 downto 0) is Estado(255 downto 192);
alias x0: std_logic_vector(63 downto 0) is Estado(319 downto 256);
...
with selector select x2p <=
	...
	(x2 xor padding&P8_0) when "10000",
	(x2 xor padding&P8_1) when "10001",
	(x2 xor padding&P8_2) when "10010",
	(x2 xor padding&P8_3) when "10011",
	(x2 xor padding&P8_4) when "10100",
	(x2 xor padding&P8_5) when "10101",
	(x2 xor padding&P8_6) when "10110",
	(x2 xor padding&P8_7) when others;
