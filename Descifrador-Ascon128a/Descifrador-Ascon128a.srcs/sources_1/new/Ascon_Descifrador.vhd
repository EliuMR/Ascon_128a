...
entity Ascon_Descifrador is
  Port (llave: in std_logic_vector(127 downto 0);
        ...
        texto_cifrado: in std_logic_vector(255 downto 0);
        reset,clock : in std_logic;
        Tag:  in std_logic_vector(127 downto 0);
        texto_descifrado: out std_logic_vector(255 downto 0));
...
alias Texto0_cifrado: std_logic_vector(127 downto 0) is texto_cifrado(255 downto 128);
alias Texto1_cifrado: std_logic_vector(127 downto 0) is texto_cifrado(127 downto 0);
...
signal Texto0_descifrado:  std_logic_vector(127 downto 0);
signal Texto1_descifrado:  std_logic_vector(127 downto 0);
signal TextoDescifrado: std_logic_vector(255 downto 0);
...
state_R: Sr port map(estado_r=>estado_contador,sr_inicial=>sr_inicial,datos_Asociados0=>datos_Asociados0,datos_Asociados1=>datos_Asociados1,Texto0_cifrado=>Texto0_cifrado,Texto1_cifrado=>Texto1_cifrado,r=>r,Rs=>R_entrada);
