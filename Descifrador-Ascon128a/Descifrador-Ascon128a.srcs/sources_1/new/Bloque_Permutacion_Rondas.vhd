...
component Permutacion is
  Port (R:in std_logic_vector(127 downto 0);
        ...
        Sc:out std_logic_vector(191 downto 0));
end component;
...
--end component;
--ronda A
signal ar_p0,ar_p1,ar_p2,ar_p3,ar_p4,ar_p5,ar_p6,ar_p7,ar_p8,ar_p9,ar_p10,ar_p11: std_logic_vector(127 downto 0);
signal ac_p0,ac_p1,ac_p2,ac_p3,ac_p4,ac_p5,ac_p6,ac_p7,ac_p8,ac_p9,ac_p10,ac_p11: std_logic_vector(191 downto 0);
--ronda B
signal br_p0,br_p1,br_p2,br_p3,br_p4,br_p5,br_p6,br_p7: std_logic_vector(127 downto 0);
signal bc_p0,bc_p1,bc_p2,bc_p3,bc_p4,bc_p5,bc_p6,bc_p7: std_logic_vector(191 downto 0);
...
B7: Permutacion port map(R=>br_p5,C=>bc_p5,Ronda_A_B=>'1',Contador_Ronda=>"0110",Sr=>br_p6,Sc=>bc_p6);
B8: Permutacion port map(R=>br_p6,C=>bc_p6,Ronda_A_B=>'1',Contador_Ronda=>"0111",Sr=>br_p7,Sc=>bc_p7);
with Ronda select S<=
                      ar_p11&ac_p11 when '0',
                      br_p7&bc_p7 when others;
end Behavioral;