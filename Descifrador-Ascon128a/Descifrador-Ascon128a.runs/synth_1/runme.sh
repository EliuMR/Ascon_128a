...
HD_PWD='D:/Documentos/Estudio/Maestria/2-Periodo/Diseno/Ascon-128a-/Descifrador-Ascon128a/Descifrador-Ascon128a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ascon_Descifrador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ascon_Descifrador.tcl
